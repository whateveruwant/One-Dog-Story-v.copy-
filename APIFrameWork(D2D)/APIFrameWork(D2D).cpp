...
ID2D1SolidColorBrush*		AquablueBrush;
ID2D1SolidColorBrush*		BlueBrush;
ID2D1RadialGradientBrush*	m_pRadialGradientBrush;
int saveDataNum = 1;
int level = 0;
float bgmSound = 1.0f;
float effectSound = 1.0f;
//랜덤인잇 or 맵툴맵 불러오기
bool tile_init_select;
//이미지 로딩 한번만
bool loading_game_first;

SGAMEKEYSETTING _mGameKey = 
{VK_UP, VK_DOWN, VK_LEFT, VK_RIGHT,VK_SPACE, 'X','C','Z','S','A','D',VK_LSHIFT};
//메인게임 클래스 선언
mainGame _mg;
...
)
{
	...
	wcex.lpszClassName = L"One Dog Story";
