...
selectDataScene::selectDataScene()
{
}
...
HRESULT selectDataScene::init(void)
{
...
void selectDataScene::release(void)
{
}

void selectDataScene::update(void)
{
	...
	case ESELECTACTIVE_DATA1:
		if (data[0]._isExist) {
			saveDataNum = 1;
			SCENEMANAGER->changeScene("mainGameAgainSC");
		}
		break;
...
void selectDataScene::render(void)
{
	...
	tchar tmpStr[10];
	swprintf_s(tmpStr, TEXT("이 어 하 기"));
