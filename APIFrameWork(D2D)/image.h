...
public:
	...
	void render(ID2D1RenderTarget* RenderTarget, float x, float y, float sourceWidth, float sourceHeight);
	void render(ID2D1RenderTarget* RenderTarget, float x, float y, float sourceX, float sourceY, float sourceWidth, float sourceHeight);

	//==================================================================
	//		## 알파렌더 ##
	//==================================================================
	void alphaRender(ID2D1RenderTarget* RenderTarget, float alpha);
	void alphaRender(ID2D1RenderTarget* RenderTarget, float x, float y, float alpha);
	
	//==================================================================
	//		## 프레임렌더 ##
	//==================================================================
	void frameRender(ID2D1RenderTarget* RenderTarget, int currentFrameX, int currentFrameY);
	void frameRender(ID2D1RenderTarget* RenderTarget, int currentFrameX, int currentFrameY, float x, float y);
	...
	void bottomRender(ID2D1RenderTarget* RenderTarget, float x, float y);
	void bottomFillOpacityRender(ID2D1RenderTarget* RenderTarget, float x, float y, ID2D1Brush* Brush);
	...
	void bottomFrameRender(ID2D1RenderTarget* RenderTarget, int currentFrameX, int currentFrameY, float x, float y);
	void bottomFrameFillOpacityRender(ID2D1RenderTarget* RenderTarget, int currentFrameX, int currentFrameY, float x, float y, ID2D1Brush* Brush);
	...
	//		## animation렌더 ## 
	//==================================================================
	void aniRender(ID2D1RenderTarget* RenderTarget, float destX, float destY, animation* ani);
	void aniBottomRender(ID2D1RenderTarget* RenderTarget, float destX, float destY, animation* ani);
	void aniBottomFillOpacityRender(ID2D1RenderTarget* RenderTarget, float destX, float destY, animation* ani, ID2D1Brush* Brush);
